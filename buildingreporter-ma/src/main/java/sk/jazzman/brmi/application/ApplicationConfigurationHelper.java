...
public class ApplicationConfigurationHelper {
	...
	public static final String MI_NAME = "buildingreporter.mi.measureinstrumnet.name";
	public static final String MI_MAC_ADDRESS = "buildingreporter.mi.measureinstrumnet.mac_address";
	public static final String MI_IP_ADDRESS = "buildingreporter.mi.measureinstrumnet.ip_address";
	 ...
	 * @return
	 */
	public static Object getSafetyValue(String attribure, Map<String, Object> configuration) {
	 ...
	 * @return
	 */
	public static Object getSafetyValue(String attribure, Configuration configuration) {
		if (configuration == null || attribure == null) {
			throw new IllegalArgumentException("Null argument!");
		}
	 ...
	 * @return
	 */
	public static Map<String, Object> getInstrumentConfiguration(Configuration configuration) {
